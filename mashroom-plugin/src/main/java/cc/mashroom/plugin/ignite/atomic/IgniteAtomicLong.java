 ...
 */
package cc.mashroom.plugin.ignite.atomic;

import  cc.mashroom.xcache.atomic.XAtomicLong;
import  lombok.AllArgsConstructor;

@AllArgsConstructor
public  class  IgniteAtomicLong      implements  XAtomicLong
{
	@Override
	...
	private  org.apache.ignite.IgniteAtomicLong  atomicLong;
	...
	{
		this.atomicLong.getAndSet( value );
	}
}