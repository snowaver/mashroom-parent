...
public  class  GenericRepository
{
	...
	public  int  insert( Reference<Object>  idRef,String  sql,Object...  params )
	{
		...
		{
			return  ConnectionUtils.fillAutoGeneratedRefs( new  ArrayList<Reference<Object>>(),new  int[]{preparedStatement.executeUpdate()},preparedStatement.getGeneratedKeys())    [ 0 ];
		}
	}
	@SneakyThrows
