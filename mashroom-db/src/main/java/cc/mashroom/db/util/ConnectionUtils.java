...
{	
	...
	public  static  int[]  addAutoGeneratedRefs(  List<Reference<Object>>  autoGeneratedRefs,int[]  counts,ResultSet  autoGeneratedKeys )  throws  SQLException
	{
	...
	public  static  int    fillAutoGeneratedRef(  Reference<Object>  autoGeneratedRef,int  count,  ResultSet  autoGeneratedKeys )  throws  SQLException
	{
		autoGeneratedRef.set(    count >= 1 && autoGeneratedKeys.next() ?  autoGeneratedKeys.getObject(1) : null );        return  count;
	}
}